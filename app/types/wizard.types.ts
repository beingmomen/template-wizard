...
export const WIZARD_STEPS: WizardStep[] = [
  ...
  { id: 2, title: 'Permissions', titleAr: 'الصلاحيات', icon: 'i-lucide-shield', visibleFor: ['fullstack', 'backend-only', 'frontend-only'] },
  ...
  { id: 5, title: 'Database', titleAr: 'قاعدة البيانات', icon: 'i-lucide-database', visibleFor: ['fullstack', 'backend-only', 'frontend-only', 'cli-tool', 'integration'] },
  { id: 6, title: 'Summary 2', titleAr: 'ملخص مع قاعدة البيانات', icon: 'i-lucide-file-text', visibleFor: ['fullstack', 'backend-only', 'frontend-only', 'cli-tool', 'integration'] },
  { id: 7, title: 'API', titleAr: 'الـ API', icon: 'i-lucide-network', visibleFor: ['fullstack', 'backend-only', 'frontend-only', 'library', 'integration'] },
